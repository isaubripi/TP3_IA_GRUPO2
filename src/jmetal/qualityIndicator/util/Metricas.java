...
public class Metricas {
    ...
    public static void main(String[] args) {
        ...
        String ruta = "c:\\salidatspkroab\\";
        String[][] arrayArchivoProblema = {{"KROAB100.TSP.TXT", "kroac100.tsp.txt"}};
        String[] arrayAlgoritmoEjecucion = {"SPEA"}; //Valores: MOACS, M3AS
        int decimales = 4;
        String pr = arrayArchivoProblema[0][0]; //[0,0] KROAB - [0,1] KROAC - [1,0] QAP.75.0 - [1,1] QAP 75.1
